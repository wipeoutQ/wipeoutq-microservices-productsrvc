 ...
 */
package com.wipeoutq.ms.product.exception;

import org.springframework.http.HttpStatus;

public class BarcodeExistsException extends CustomException {

	public BarcodeExistsException() {

		super(ErrorCode.BARCODE_EXISTS, HttpStatus.BAD_REQUEST);
	}
