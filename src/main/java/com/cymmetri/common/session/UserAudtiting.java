...
public class UserAudtiting implements AuditorAware<String> {
	...
	public Optional<String> getCurrentAuditor() {
		...
		Principal principalObj = PrincipalContext.getPrincipal();

		String principal = principalObj.getPrincipal();

		if (principalObj.getIsDelegate()) {
			principal = principalObj.getDelegatee();
		}
